...
<div id="sidebar-wrapper">
    <div class="sidebar-heading text-center py-4">
        <a class="navbar-brand text-light" href="../index.php">LMS Instruktur</a>
        <button id="close-sidebar" class="btn"><i class="fas fa-times"></i></button>
    </div>
    <div class="list-group list-group-flush">
        <a href="../instructor/dashboard.php" class="list-group-item list-group-item-action">Dashboard</a>
        <a href="../instructor/manage_courses.php" class="list-group-item list-group-item-action">Kelola kursus</a>
        <a href="../instructor/view_all_course.php" class="list-group-item list-group-item-action">View all course</a>
                        <script>
